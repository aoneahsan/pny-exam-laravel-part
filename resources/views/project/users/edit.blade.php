...
<form method="post" action="{{ url('admin/users/'.$user->id) }}" class="custom_div_1" enctype="multipart/form-data">
	...
	<div class="row form-group">
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-xs-9 d-inline-block">
				<input type="text" value="{{ $user->user_details->cnic }}" name="cnic" class="form-control" style="width: 100%;">
			</div>
		</div>
		<div class="col-xs-12 col-sm-6">
			<div class="col-xs-3 d-inline-block">
	...
	<div class="row form-group">
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-xs-9 d-inline-block">
				<input type="text" name="phone_number" value="{{ $user->phone_number }}" required="required" value="" class="form-control" style="width: 100%;">
			</div>
		</div>
	</div>
