...
Route::post('quizzes', 'Api\ApiQuizController@getQuizzes');
Route::post('quiz-data', 'Api\ApiQuizController@getQuizData');
Route::post('quiz-questions', 'Api\ApiQuizController@getQuizQuestions');
Route::post('quiz-report', 'Api\ApiQuizController@saveQuizReport');
Route::post('user-quiz-reports', 'Api\ApiQuizController@getUserQuizReports');